 ...
 * Purpose: Write a program to handle cashcounter problem for enqueue the customers and dequeue after transaction
 */
...
public class CashCounter {
	...
	//Enter the Person into queue (Enqueue)
	...
	//Remove the Person from the Queue (Dequeue)
	public int Dequeue() {
...
public static void main(String[] args) {
		...
		CashCounter cc = new CashCounter(number);
