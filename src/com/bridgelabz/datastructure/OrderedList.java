 ...
 * Purpose: Using Generic read file and delete the number if already present else add number if not present
 */
...
public class OrderedList{
	...
	//Adding Data in Generic Linked List
	public void add(int item) {
		new Node(item); 
	}
		
	//Removing Data in Generic Linked List
